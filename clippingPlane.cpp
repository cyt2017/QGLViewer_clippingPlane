...
void Viewer::draw() {
  ...
  glPushMatrix();//将所有矩阵依次压入堆栈中，顶部矩阵是第二个矩阵的备份
  ...
  glClipPlane(GL_CLIP_PLANE0, equation);//设置一个剪切平面

  // Draw a plane representation: Its normal...
  glColor3f(0.8f, 0.8f, 0.8f);
  drawArrow(0.4f, 0.015f);//!绘制箭头
...
void Viewer::init() {
  // Restore previous viewer state.刷新viewer界面
